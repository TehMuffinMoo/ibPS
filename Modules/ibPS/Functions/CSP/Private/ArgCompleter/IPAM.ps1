...
Register-ArgumentCompleter -CommandName 'Get-B1FederatedBlock','Get-B1ReservedBlock','Get-B1OverlappingBlock','Get-B1FederatedPool', 'New-B1FederatedPool' -ParameterName Realm -ScriptBlock $Arg_IPAM_Federated_Realms
...
Register-ArgumentCompleter -CommandName 'Get-B1FederatedBlock','Get-B1ForwardLookingDelegation' -ParameterName Pool -ScriptBlock $Arg_IPAM_Federated_Pools