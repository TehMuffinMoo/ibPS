function Set-B1TDLookalikeTarget {
  <#
  .SYNOPSIS
  ...
  .EXAMPLE
    PS> Set-B1TDLookalikeTarget -Domain "mydomain.com" -Description "New description.." 

  .EXAMPLE
    PS> Set-B1TDLookalikeTarget -Domain "mydomain.com","seconddomain.com" -Description "New Description 1","New Description 2"

  .EXAMPLE
    PS> Set-B1TDLookalikeTarget -Domain "mydomain.com","seconddomain.com" -Description "New Common description"
