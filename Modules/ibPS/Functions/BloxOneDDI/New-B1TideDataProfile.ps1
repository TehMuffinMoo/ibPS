function New-B1TideDataProfile {
    ...
    if ($TIDEDataProfile) {
      ...
      $Result = Query-CSP -Method "POST" -Uri "$(Get-B1CSPUrl)/tide/admin/v1/resources/dataprofiles" -Data $splat | select -ExpandProperty profile -ErrorAction SilentlyContinue
