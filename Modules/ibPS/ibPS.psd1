...
Copyright = '(c) 2021-2026 Mat Cox. All rights reserved.'
...
FunctionsToExport = 'Get-B1ConnectionProfile', 'New-B1ConnectionProfile', 
               ...
               'Deploy-B1Appliance', 'Disable-B1HostLocalAccess', 
               ...
               'Get-B1Location', 'Get-B1RecycleBin', 'Get-B1SecurityLog', 
               'Get-B1Service', 'Get-B1ServiceLog', 'Get-B1Subtenant', 'Get-B1Tag', 
               'Get-B1Tokens', 'Get-B1User', 'Get-B1UserAPIKey', 'New-B1APIKey', 
               'New-B1Host', 'New-B1Location', 'New-B1Service', 'New-B1Subtenant', 
               'Optimize-B1ServerTokens', 'Receive-B1Export', 'Remove-B1APIKey', 
               'Remove-B1Host', 'Remove-B1Location', 'Remove-B1RecycleBin', 
               'Remove-B1Service', 'Remove-B1Subtenant', 'Restart-B1Host', 
               'Restore-B1RecycleBin', 'Search-B1', 'Set-B1APIKey', 'Set-B1Host', 
               'Set-B1Location', 'Set-B1Service', 'Set-B1Subtenant', 
               ...
               'Get-B1AuthoritativeZone', 'Get-B1CloudProvider', 
               'Get-B1DelegatedZone', 'Get-B1Delegation', 'Get-B1DFP', 
               ...
               'Get-B1FederatedBlock', 'Get-B1FederatedPool', 'Get-B1FederatedRealm', 
               'Get-B1FixedAddress', 'Get-B1ForwardLookingDelegation', 
               'Get-B1ForwardNSG', 'Get-B1ForwardZone', 'Get-B1GlobalNTPConfig', 
               'Get-B1HAGroup', 'Get-B1IPAMChild', 'Get-B1NTPServiceConfiguration', 
               'Get-B1OverlappingBlock', 'Get-B1Range', 'Get-B1Record', 
               'Get-B1ReservedBlock', 'Get-B1Space', 'Get-B1Subnet', 
               'Get-B1SubnetNextAvailable', 'Get-B1ThirdPartyProvider', 
               ...
               'New-B1DelegatedZone', 'New-B1DHCPConfigProfile', 'New-B1DNSACLItem', 
               'New-B1DNSView', 'New-B1DTCHealthCheck', 'New-B1DTCLBDN', 
               'New-B1DTCPolicy', 'New-B1DTCPool', 'New-B1DTCServer', 
               'New-B1DTCTopologyRule', 'New-B1FixedAddress', 'New-B1ForwardZone', 
               'New-B1HAGroup', 'New-B1Range', 'New-B1Record', 'New-B1Space', 
               'New-B1Subnet', 'Remove-B1AddressBlock', 
               ...
               'Remove-B1DTCHealthCheck', 'Remove-B1DTCLBDN', 'Remove-B1DTCPolicy', 
               'Remove-B1DTCPool', 'Remove-B1DTCServer', 'Remove-B1FixedAddress', 
               'Remove-B1ForwardZone', 'Remove-B1HAGroup', 'Remove-B1Range', 
               'Remove-B1Record', 'Remove-B1Space', 'Remove-B1Subnet', 
               ...
               'Set-B1Record', 'Set-B1Subnet', 'Build-B1CubeJSFilter', 'Get-B1Object', 
               'Get-B1Schema', 'Invoke-B1CubeJS', 'New-B1Object', 'Remove-B1Object', 
               'Set-B1Object', 'Get-NIOSConnectionProfile', 
               ...
               'Set-ibPSConfiguration', 'Invoke-CSP', 'Update-B1AuthoritativeZoneSerial'
...
AliasesToExport = 'Apply-B1HostDHCPConfigProfile', 'Apply-B1HostDNSConfigProfile', 
               ...
               'Get-B1AASTunnels', 'Get-B1Server', 'Get-BCP', 'Get-NCP', 'New-B1Server', 
               'New-BCP', 'New-NCP', 'Remove-B1HostDHCPConfigProfile', 
               'Remove-B1HostDNSConfigProfile', 'Remove-B1Server', 'Remove-BCP', 
               'Remove-NCP', 'Restart-B1Server', 'Set-B1Server', 'Set-BCP', 'Switch-BCP', 
               'Switch-NCP'
