...
FunctionsToExport = 'Get-B1ConnectionProfile', 'New-B1ConnectionProfile', 
               ...
               'Get-B1Service', 'Get-B1ServiceLog', 'Get-B1Tag', 'Get-B1Tokens', 
               'Get-B1User', 'Get-B1UserAPIKey', 'New-B1APIKey', 'New-B1Host', 
               'New-B1Location', 'New-B1Service', 'Optimize-B1ServerTokens', 
               'Receive-B1Export', 'Remove-B1APIKey', 'Remove-B1Host', 
               'Remove-B1Location', 'Remove-B1RecycleBin', 'Remove-B1Service', 
               'Restart-B1Host', 'Restore-B1RecycleBin', 'Search-B1', 'Set-B1APIKey', 
               'Set-B1Host', 'Set-B1Location', 'Start-B1DiagnosticTask', 
               ...
               'Set-ibPSConfiguration', 'Invoke-CSP', 'Get-B1Subtenant', 'Remove-B1Subtenant', 'New-B1Subtenant', 'Set-B1Subtenant'
