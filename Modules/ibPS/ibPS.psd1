...
FunctionsToExport = 'Deploy-B1Appliance', 'Get-B1Address', 'Get-B1AddressBlock', 
               ...
               'Get-B1Subnet', 'Get-B1Tag', 'Get-B1TDDossierLookup', 
               ...
               'New-NIOSDelegatedZone', 'Store-NIOSCredentials', 
               'Migrate-NIOSSubzoneToBloxOne', 'Get-ibPSVersion'
