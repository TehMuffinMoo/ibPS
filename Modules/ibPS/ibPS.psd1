...
FunctionsToExport = 'Deploy-B1Appliance', 'Get-B1Address', 'Get-B1AddressBlock', 
               ...
               'Set-B1Host', 'Set-B1NTPServiceConfiguration', 'Set-B1Object', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'v1.9.1.3 - Add ability to deploy to both VMware & Hyper-V platforms. -Type is a new mandatory parameter when using Deploy-B1Appliance.
