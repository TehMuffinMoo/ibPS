...
FunctionsToExport = 'Get-B1ConnectionProfile', 'New-B1ConnectionProfile', 
               ...
               'Remove-B1DelegatedZone', 'Remove-B1Delegation', 
               ...
               'Remove-B1FederatedBlock', 'Remove-B1FederatedPool', 
               'Remove-B1FederatedRealm', 'Remove-B1FixedAddress', 
               'Remove-B1ForwardLookingDelegation', 'Remove-B1ForwardZone', 
               'Remove-B1HAGroup', 'Remove-B1IPAMHost', 'Remove-B1OverlappingBlock', 
               'Remove-B1Range', 'Remove-B1Record', 'Remove-B1ReservedBlock', 
               ...
               'Set-B1IPAMHost', 'Set-B1NTPServiceConfiguration', 'Set-B1Range', 
