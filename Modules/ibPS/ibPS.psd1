...
FunctionsToExport = 'Get-B1APIKey', 'Get-B1AuditLog', 'Get-B1BootstrapConfig', 
               ...
               'Get-B1AddressBlockNextAvailable', 'Get-B1Applications', 
               ...
               'Get-B1Record', 'Get-B1Space', 'Get-B1Subnet', 'Get-B1TopMetrics', 
               'Get-B1ZoneChild', 'Grant-B1DHCPConfigProfile', 
               ...
               'Set-B1Subnet', 'Deploy-B1Appliance', 'Get-B1HealthCheck', 'Get-B1Host', 
               'Get-B1Service', 'New-B1Host', 'New-B1Service', 'Reboot-B1Host', 
               'Remove-B1Host', 'Remove-B1Service', 'Set-B1Host', 
               'Start-B1DiagnosticTask', 'Start-B1Service', 'Stop-B1Service', 
               'Disable-B1TDLookalike', 'Disable-B1TDLookalikeTargetCandidate', 
               'Enable-B1TDLookalike', 'Enable-B1TDLookalikeTargetCandidate', 
