...
FunctionsToExport = 'Deploy-B1Appliance', 'Get-B1Address', 'Get-B1AddressBlock', 
               ...
               'Get-B1SecurityLog', 'Get-B1Service', 'Get-B1ServiceLog', 'Get-B1Space', 
               'Get-B1Subnet', 'Get-B1Tag', 'Get-B1TDContentCategory', 
               ...
               'New-B1Record', 'New-B1Service', 'New-B1Space', 'New-B1Subnet', 
               'New-B1TDTideDataProfile', 'Reboot-B1Host', 'Remove-B1AddressBlock', 
               'Remove-B1AddressReservation', 'Remove-B1APIKey', 
               'Remove-B1AuthoritativeZone', 'Remove-B1DHCPConfigProfile', 
               'Remove-B1DNSConfigProfile', 'Remove-B1FixedAddress', 
               'Remove-B1ForwardZone', 'Remove-B1HAGroup', 'Remove-B1Host', 
               'Remove-B1Range', 'Remove-B1Record', 'Remove-B1Service', 
               'Remove-B1Subnet', 'Remove-B1TDNetworkList', 
               'Remove-B1TDSecurityPolicy', 'Revoke-B1DHCPConfigProfile', 
               'Revoke-B1DNSConfigProfile', 'Search-B1', 'Set-B1AddressBlock', 
               'Set-B1APIKey', 'Set-B1AuthoritativeZone', 'Set-B1CSPUrl', 
