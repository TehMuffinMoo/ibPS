...
FunctionsToExport = 'Get-B1APIKey', 'Get-B1AuditLog', 'Get-B1BulkOperation', 
               ...
               'Get-B1Licenses', 'Get-B1Location', 'Get-B1SecurityLog', 
               ...
               'Get-B1BootstrapConfig', 'Get-B1DiagnosticTask', 'Get-B1HealthCheck', 
               ...
               'Get-B1CustomList', 'Get-B1DossierLookup', 
               ...
               'Set-ibPSConfiguration', 'Invoke-CSP', 'Get-NIOSFileOp'
