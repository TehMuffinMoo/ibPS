...
FunctionsToExport = 'Get-B1ConnectionProfile', 'New-B1ConnectionProfile', 
               ...
               'Get-B1ServiceLog', 'Get-B1Tag', 'Get-B1Tokens', 'Get-B1User', 
               'Get-B1UserAPIKey', 'New-B1APIKey', 'New-B1Host', 'New-B1Location', 
               'New-B1Service', 'Optimize-B1ServerTokens', 'Receive-B1Export', 
               'Remove-B1APIKey', 'Remove-B1Host', 'Remove-B1Location', 
               'Remove-B1Service', 'Restart-B1Host', 'Search-B1', 'Set-B1APIKey', 
               ...
               'Resolve-DoHQuery', 'Set-ibPSConfiguration', 'Invoke-CSP', 'Get-B1RecycleBin', 'Remove-B1RecycleBin', 'Restore-B1RecycleBin'
