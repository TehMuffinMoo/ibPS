...
FunctionsToExport = 'Get-B1APIKey', 'Get-B1AuditLog', 'Get-B1BulkOperation', 
               ...
               'Get-B1Applications', 'Get-B1BootstrapConfig', 'Get-B1DiagnosticTask', 
               'Get-B1HealthCheck', 'Get-B1Host', 'Get-B1HostLocalAccess', 
               'Get-B1Service', 'New-B1Host', 'New-B1Service', 'Remove-B1Host', 
               'Remove-B1Service', 'Restart-B1Host', 'Set-B1Host', 
