...
FunctionsToExport = 'Get-B1APIKey', 'Get-B1AuditLog', 'Get-B1BootstrapConfig', 
               ...
               'Stop-B1Service', 'Disable-B1TDLookalike', 
               'Disable-B1TDLookalikeTargetCandidate', 'Enable-B1TDLookalike', 
               'Enable-B1TDLookalikeTargetCandidate', 'Get-B1TDContentCategory', 
               'Get-B1TDDossierLookup', 'Get-B1TDDossierSupportedFeedback', 
               ...
               'Get-B1TDLookalikeTargets', 'Get-B1TDLookalikeTargetSummary', 
               'Get-B1TDNetworkList', 'Get-B1TDPoPRegion', 'Get-B1TDSecurityPolicy', 
               'Get-B1TDSecurityPolicyRules', 'Get-B1TDSOCInsight', 
               'Get-B1TDSOCInsightAssets', 'Get-B1TDSOCInsightComments', 
               'Get-B1TDSOCInsightEvents', 'Get-B1TDSOCInsightIndicators', 
               'Get-B1TDThreatFeeds', 'Get-B1TDTideDataProfile', 'Get-B1TDTideFeeds', 
               'Get-B1TDTideInfoRank', 'Get-B1TDTideThreatClass', 
               'Get-B1TDTideThreatClassDefaultTTL', 'Get-B1TDTideThreatCounts', 
               'Get-B1TDTideThreatEnrichment', 'Get-B1TDTideThreatInsightClass', 
               'Get-B1TDTideThreatProperty', 'Get-B1TDTideThreats', 
               'New-B1TDLookalikeTarget', 'New-B1TDTideDataProfile', 
               'Remove-B1TDLookalikeTarget', 'Remove-B1TDNetworkList', 
               'Remove-B1TDSecurityPolicy', 'Set-B1TDLookalikeTarget', 
               'Set-B1TDSOCInsight', 'Set-B1TDTideDataProfile', 
               'Start-B1TDDossierBatchLookup', 'Start-B1TDDossierLookup', 
               'Submit-B1TDTideData', 'Get-B1Object', 'Get-B1Schema', 'New-B1Object', 
