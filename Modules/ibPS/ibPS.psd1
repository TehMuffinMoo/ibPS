...
FunctionsToExport = 'Get-B1APIKey', 'Get-B1AuditLog', 'Get-B1BulkOperation', 
               ...
               'Get-B1Export', 'Get-B1Licenses', 'Get-B1Location', 'Get-B1SecurityLog', 
               'Get-B1ServiceLog', 'Get-B1Tag', 'Get-B1User', 'Get-B1UserAPIKey', 
               'New-B1APIKey', 'New-B1Location', 'Remove-B1APIKey', 
               ...
               'Get-B1BypassCode', 'Get-B1ContentCategory', 'Get-B1CustomList', 
               ...
               'New-B1TideDataProfile', 'Remove-B1BypassCode', 
               'Remove-B1InternalDomainList', 'Remove-B1LookalikeTarget', 
               'Remove-B1NetworkList', 'Remove-B1SecurityPolicy', 
