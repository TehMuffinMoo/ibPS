...
FunctionsToExport = 'Deploy-B1Appliance', 'Get-B1Address', 'Get-B1AddressBlock', 
               ...
               'New-B1ForwardZone', 'New-B1HAGroup', 'New-B1Host', 'New-B1Object', 
               'New-B1Range', 'New-B1Record', 'New-B1Service', 'New-B1Space', 
               ...
               'Remove-B1Space', 'Remove-B1Subnet', 'Remove-B1TDNetworkList', 
               'Remove-B1TDSecurityPolicy', 'Revoke-B1DHCPConfigProfile', 
               ...
               'Stop-B1Service', 'Copy-NIOSSubzoneToBloxOne', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'v1.9.2.5 - Add New-B1Object cmdlet to the generic cmdlet offering. This now includes all Get, Set, New & Remove cmdlets.'
