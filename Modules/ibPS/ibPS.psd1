...
FunctionsToExport = 'Deploy-B1Appliance', 'Get-B1Address', 
               'Get-B1AddressBlockNextAvailable', 'Get-B1AuthoritativeNSG', 
               'Get-B1BootstrapConfig', 'Get-B1BulkOperation', 'Get-B1CSPUrl', 
               'Get-B1DHCPConfigProfile', 'Get-B1DHCPGlobalConfig', 'Get-B1DHCPHost', 
               'Get-B1DHCPLease', 'Get-B1DHCPOptionCode', 'Get-B1DHCPOptionGroup', 
               ...
               'Get-B1ForwardNSG', 'Get-B1GlobalNTPConfig', 'Get-B1HAGroup', 
               'Get-B1HealthCheck', 'Get-B1Host', 'Get-B1NTPServiceConfiguration', 
               'Get-B1Service', 'Get-B1Space', 'Get-B1Tag', 'Get-B1TopMetrics', 
               ...
               'Stop-B1Service', 'Get-B1Applications', 'Get-B1DFP', 
               ...
               'Set-B1TDTideDataProfile', 'Get-B1CSPAPIKey', 'Get-B1TDDossierLookup', 
               'Search-B1', 'Set-B1Range', 'Start-B1TDDossierBatchLookup', 
               'Start-B1TDDossierLookup', 'Store-B1CSPAPIKey', 'New-B1APIKey', 
               'Remove-B1APIKey', 'Set-B1APIKey', 'Get-B1APIKey', 'Get-B1AddressBlock', 
               'Get-B1AuthoritativeZone', 'Get-B1DFPLog', 'Get-B1DHCPLog', 
               'Get-B1DNSEvent', 'Get-B1DNSLog', 'Get-B1DelegatedZone', 
               'Get-B1ForwardZone', 'Get-B1Range', 'Get-B1Record', 'Get-B1SecurityLog', 
               'Get-B1ServiceLog', 'Get-B1Subnet', 'Get-B1TDLookalikeDomains', 
               'Get-B1TDLookalikes', 'Get-B1User', 'Get-B1UserAPIKey', 
