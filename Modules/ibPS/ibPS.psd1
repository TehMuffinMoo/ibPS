...
FunctionsToExport = 'Get-B1ConnectionProfile', 'New-B1ConnectionProfile', 
               ...
               'Get-B1HAGroup', 'Get-B1IPAMChild', 'Get-B1IPAMHost', 
               'Get-B1NTPServiceConfiguration', 'Get-B1OverlappingBlock', 
               'Get-B1Range', 'Get-B1Record', 'Get-B1ReservedBlock', 'Get-B1Space', 
               'Get-B1Subnet', 'Get-B1SubnetNextAvailable', 
               ...
               'New-B1FederatedBlock', 'New-B1FederatedPool', 'New-B1FederatedRealm', 
               'New-B1FixedAddress', 'New-B1ForwardLookingDelegation', 
               'New-B1ForwardZone', 'New-B1HAGroup', 'New-B1OverlappingBlock', 
               'New-B1Range', 'New-B1Record', 'New-B1ReservedBlock', 'New-B1Space', 
               ...
               'Remove-B1DTCPool', 'Remove-B1DTCServer', 'Remove-B1FederatedBlock', 
               'Remove-B1FederatedPool', 'Remove-B1FederatedRealm', 
               'Remove-B1FixedAddress', 'Remove-B1ForwardLookingDelegation', 
               'Remove-B1ForwardZone', 'Remove-B1HAGroup', 'Remove-B1IPAMHost', 
               'Remove-B1OverlappingBlock', 'Remove-B1Range', 'Remove-B1Record', 
