...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'v1.9.1.1 - Add -Fields parameter on all supported Get- cmdlets
v1.9.1.0 - Minor updates & begin testing -CustomFilters parameter'
