...
FunctionsToExport = 'Get-B1APIKey', 'Get-B1AuditLog', 'Get-B1BootstrapConfig', 
               ...
               'Get-B1UserAPIKey', 'New-B1APIKey', 'Remove-B1APIKey', 
               'Remove-B1Object', 'Search-B1', 'Set-B1APIKey', 'Set-B1CSPAPIKey', 
               'Set-B1CSPUrl', 'Start-B1Export', 'Get-B1Address', 'Get-B1AddressBlock', 
               ...
               'Get-B1DHCPGlobalConfig', 'Get-B1DHCPHost', 'Get-B1DHCPLease', 
               ...
               'Set-B1Object', 'Copy-NIOSSubzoneToBloxOne', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '- Remove mandatory flag in the `New-B1Subnet` & `New-B1Space` cmdlets for the `-Name` parameter
