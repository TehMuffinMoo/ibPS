...
FunctionsToExport = 'Get-B1ConnectionProfile', 'New-B1ConnectionProfile', 
               ...
               'New-B1DTCTopologyRule', 'New-B1FederatedBlock', 
               'New-B1FederatedPool', 'New-B1FederatedRealm', 'New-B1FixedAddress', 
               ...
               'Remove-B1DTCPool', 'Remove-B1DTCServer', 'Remove-B1FederatedPool', 
               'Remove-B1FederatedRealm', 'Remove-B1FixedAddress', 
               ...
               'Set-B1Record', 'Set-B1Subnet', 'Update-B1AuthoritativeZoneSerial', 
               ...
               'Resolve-DoHQuery', 'Set-ibPSConfiguration', 'Invoke-CSP', 'Get-B1IPAMHost', 'Set-B1IPAMHost', 'Remove-B1IPAMHost'
