...
FunctionsToExport = 'Get-B1APIKey', 'Get-B1AuditLog', 'Get-B1BootstrapConfig', 
               ...
               'Get-B1SOCInsight', 'Get-B1SOCInsightAssets', 
               'Get-B1SOCInsightComments', 'Get-B1SOCInsightEvents', 
               'Get-B1SOCInsightIndicators', 'Get-B1TDContentCategory', 
               ...
               'Get-B1TideThreats', 'New-B1LookalikeTarget', 'New-B1TideDataProfile', 
