...
FunctionsToExport = 'API', 'JWT', 'Connect-B1Account', 'Disconnect-B1Account', 
               ...
               'Get-B1APIKey', 'Get-B1Applications', 'Get-B1AsAServiceCapabilities', 
               'Get-B1AsAServiceConfigChanges', 'Get-B1AsAServiceDeployments', 
               'Get-B1AsAServiceServices', 'Get-B1AsAServiceServiceStatus', 
               'Get-B1AsAServiceTunnels', 'Get-B1AuditLog', 'Get-B1BootstrapConfig', 
               'Get-B1BulkOperation', 'Get-B1Compartment', 'Get-B1CSPCurrentUser', 
               'Get-B1DFPLog', 'Get-B1DHCPLog', 'Get-B1DiagnosticTask', 
               'Get-B1DNSEvent', 'Get-B1DNSLog', 'Get-B1Export', 'Get-B1HealthCheck', 
               'Get-B1Host', 'Get-B1HostLocalAccess', 'Get-B1Import', 'Get-B1Licenses', 
