...
FunctionsToExport = 'Deploy-B1Appliance', 'Get-B1Address', 'Get-B1AddressBlock', 
               ...
               'Get-B1Host', 'Get-B1NTPServiceConfiguration', 'Get-B1Range', 
               ...
               'Get-B1DFP', 'Get-B1TDDossierSupportedFeedback', 
               ...
               'Set-B1TDTideDataProfile', 'Get-NIOSCredentials', 
