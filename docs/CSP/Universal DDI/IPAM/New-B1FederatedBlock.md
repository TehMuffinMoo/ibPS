...
```
New-B1FederatedBlock [-Subnet] <String> [[-CIDR] <Int32>] [[-Name] <String>] [[-Description] <String>]
 [-Realm] <String> [[-Pool] <String>] [[-DefaultPrefixLength] <Int32>] [[-MinimumPrefixLength] <Int32>]
 [[-MaximumPrefixLength] <Int32>] [[-Tags] <Object>] [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### EXAMPLE 1
```powershell
New-B1FederatedBlock -Subnet 10.0.0.0/8 -Name "Block-1" -Description "This is a test block" -Realm "Realm-1" -Pool "Pool-1" -Protocol "ip4" -DefaultPrefixLength 24 -MinimumPrefixLength 16 -MaximumPrefixLength 28 -Tags @{Environment="Test";Owner="Admin"}
```

## PARAMETERS

### -Subnet
The network address of the Federated Block you are creating.
