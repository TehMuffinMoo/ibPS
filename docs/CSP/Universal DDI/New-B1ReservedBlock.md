...
```
New-B1ReservedBlock [-Subnet] <String> [[-CIDR] <Int32>] [[-Name] <String>] [[-Description] <String>]
...
### EXAMPLE 1
```powershell
New-B1ReservedBlock -Subnet 10.0.0.0/8 -Name "ReservedBlock-1" -Description "My Reserved Block" -Realm "Realm-1" -Pool "Pool-1" -Tags @{Environment="Test";Owner="Admin"}
```

## PARAMETERS

### -Subnet
The network address of the Reserved Block you are creating.
