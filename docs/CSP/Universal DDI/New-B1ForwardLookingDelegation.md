...
# New-B1ForwardLookingDelegation
...
```
New-B1ForwardLookingDelegation [-Subnet] <String> [[-CIDR] <Int32>] [[-Name] <String>]
 [[-Description] <String>] [-Realm] <String> [[-Pool] <String>] [[-Tags] <Object>] [-Force] [-WhatIf]
...
### EXAMPLE 1
```powershell
New-B1ForwardLookingDelegation -Subnet 10.0.0.0/8 -Name "Delegation-1" -Description "My FLD" -Realm "Realm-1" -Pool "Pool-1" -Tags @{Environment="Test";Owner="Admin"}
```

## PARAMETERS

### -Subnet
The network address of the Forward Looking Delegation you are creating.
