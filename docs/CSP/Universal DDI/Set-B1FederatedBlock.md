...
### Subnet
```
Set-B1FederatedBlock [-Subnet <String>] [-NewName <String>] [-Description <String>] [-CIDR <Int32>]
 [-DefaultPrefixLength <Int32>] [-MinimumPrefixLength <Int32>] [-MaximumPrefixLength <Int32>] [-Tags <Object>]
 [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name
```
Set-B1FederatedBlock [-Name <String>] [-NewName <String>] [-Description <String>] [-CIDR <Int32>]
 [-DefaultPrefixLength <Int32>] [-MinimumPrefixLength <Int32>] [-MaximumPrefixLength <Int32>] [-Tags <Object>]
 [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
### Object
```
Set-B1FederatedBlock [-NewName <String>] [-Description <String>] [-CIDR <Int32>] [-DefaultPrefixLength <Int32>]
 [-MinimumPrefixLength <Int32>] [-MaximumPrefixLength <Int32>] [-Tags <Object>] -Object <Object> [-Force]
...
### EXAMPLE 1
```powershell
Set-B1FederatedBlock -Subnet '10.1.5.0/24' -NewName "New name" -Description "Updated description" -Tags @{Environment="Test";Owner="Admin"}
```

### EXAMPLE 2
```powershell
Get-B1FederatedBlock -Name "Block-1" -Realm "Realm-1" | Set-B1FederatedBlock -CIDR 15 -Description "Updated to /15" -Tags @{Environment="Test";Owner="Admin"}
```
...
### -Tags
A list of tags to update on the federated block.
...
### -Object
The Federated Block Object to update.
