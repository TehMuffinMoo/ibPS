...
- Add `Get-B1FederatedRealm`, `New-B1FederatedRealm`, `Set-B1FederatedRealm` & `Remove-B1FederatedRealm`
- Add `Get-B1FederatedPool`, `New-B1FederatedPool`, `Set-B1FederatedPool` & `Remove-B1FederatedPool`
- Add `Get-B1FederatedBlock`, `New-B1FederatedBlock`, `Set-B1FederatedBlock` & `Remove-B1FederatedBlock`
- Add `Get-B1ForwardLookingDelegation`, `New-B1ForwardLookingDelegation`, `Set-B1FederatedForwardLookingDelegation` & `Remove-B1ForwardLookingDelegation`
- Add `Get-B1OverlappingBlock`, `New-B1OverlappingBlock`, `Set-B1OverlappingBlock`, `Remove-B1OverlappingBlock`
