...
### None (Default)
```
Get-B1CSPCurrentUser [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Groups
```
Get-B1CSPCurrentUser [-Groups] [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Account
```
Get-B1CSPCurrentUser [-Account] [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Compartments
```
Get-B1CSPCurrentUser [-Compartments] [-Force] [-WhatIf] [-Confirm] [<CommonParameters>]
```
