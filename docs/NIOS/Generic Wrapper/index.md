...
## INVOKE
The `Invoke-NIOS` cmdlet can be used as a barebones wrapper for the interfacing with NIOS either directly or via NIOS Federation. This is a core function and is used by every other NIOS cmdlet within the ibPS Module.
